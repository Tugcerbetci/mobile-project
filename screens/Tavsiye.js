  ...
  return (
    <ScrollView contentContainerStyle={{ paddingVertical: 20 }}>
      <View style={{ paddingHorizontal: 20 }}>
        <ImageBackground 
          source={{ uri: 'https://iasbh.tmgrup.com.tr/844120/430/243/0/128/1254/835?u=https://isbh.tmgrup.com.tr/sbh/2022/12/06/kan-sekeri-500-normal-mi-tokluk-ve-aclik-kan-sekerim-500-cikti-yuksek-mi-dusuk-mu-s1-1670311552468.jpg' }} 
        ...
        <ImageBackground 
          source={{ uri: 'https://www.buyukanadoluhastanesi.com/images/news/actual/Yuksek_Tansiyon_Belirtileri_-_Buyuk_Anadolu_Hastanesi.jpg' }} 
          style={styles.infoContainer} 
          imageStyle={styles.backgroundImageStyle}
        >
          <View style={styles.infoTextContainer}>
        ...
        <ImageBackground 
          source={{ uri: 'https://klasikyoga.com/wp-content/uploads/2014/05/ar%C4%B1-su.jpg' }} 
          style={styles.infoContainer} 
          imageStyle={styles.backgroundImageStyle}
        >
          <View style={styles.infoTextContainer}>
        ...
        <ImageBackground 
          source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-B3Dg-HTDAf21A1BeqgXznJj0EPB8h6Z-xg&s' }} 
          style={styles.infoContainer} 
          imageStyle={styles.backgroundImageStyle}
        >
          <View style={styles.infoTextContainer}>
        ...
        <ImageBackground 
          source={{ uri: 'https://www.yenihayattipmerkezi.com/wp-content/uploads/2022/12/ob3.jpg' }} 
          style={styles.infoContainer} 
          imageStyle={styles.backgroundImageStyle}
        >
          <View style={styles.infoTextContainer}>
